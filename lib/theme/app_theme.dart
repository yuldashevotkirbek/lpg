...
/// A class that contains all theme configurations for the LPG delivery application.
class AppTheme {
  AppTheme._();

  // Professional Energy Palette - Deep blues and energetic oranges
  ...
  static const Color backgroundLight = Color(0xFFFAFBFC); // Clean background
  ...
  static const Color neutralLightColor = Color(0xFFECF0F1); // Subtle borders
  static const Color neutralDarkColor = Color(0xFF7F8C8D); // Secondary text
  ...
  static const Color neutralLightColorDark = Color(0xFF3A3A3A);
  static const Color neutralDarkColorDark = Color(0xFF9E9E9E);
  ...
  static const Color textHighEmphasisLight = Color(0xFF2C3E50); // High contrast
  static const Color textMediumEmphasisLight =
  Color(0xFF7F8C8D); // Secondary text
  static const Color textDisabledLight = Color(0xFFBDC3C7); // Inactive states

  static const Color textHighEmphasisDark = Color(0xFFFFFFFF);
  static const Color textMediumEmphasisDark = Color(0xFF9E9E9E);
  static const Color textDisabledDark = Color(0xFF616161);

  /// Light theme optimized for LPG delivery service
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      outlineVariant: neutralLightColor,
      shadow: shadowLight,
      scrim: shadowLight,
    ...
    // AppBar theme for professional reliability
    ...
    // Floating action button for primary actions like "Place Order"
    ...
    // Button themes for CTAs and actions
    ...
    // Input decoration for forms and ordering
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: BorderSide(color: neutralLightColor),
      ),
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: primaryLight,
      linearTrackColor: neutralLightColor,
    ),
    ...
    sliderTheme: SliderThemeData(
      ...
      inactiveTrackColor: neutralLightColor,
    ),
  ...
  /// Dark theme for LPG delivery service
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      outline: dividerDark,
      outlineVariant: neutralLightColorDark,
      shadow: shadowDark,
      scrim: shadowDark,
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: BorderSide(color: neutralLightColorDark),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8.0),
        borderSide: BorderSide(color: neutralLightColorDark),
    ...
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: primaryDark,
      linearTrackColor: neutralLightColorDark,
    ),
    sliderTheme: SliderThemeData(
      activeTrackColor: primaryDark,
      thumbColor: primaryDark,
      overlayColor: primaryDark.withAlpha(51),
      inactiveTrackColor: neutralLightColorDark,
    ),
    tabBarTheme: TabBarThemeData(
  ...
  /// Custom text styles for data display (order numbers, prices, tracking codes)
  ...
  /// Helper method to get neutral colors based on theme
  static Color getNeutralLightColor(bool isLight) {
    return isLight ? neutralLightColor : neutralLightColorDark;
  }

  static Color getNeutralDarkColor(bool isLight) {
    return isLight ? neutralDarkColor : neutralDarkColorDark;
  }
}